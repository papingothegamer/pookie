...
const TextSection: React.FC = () => {
  return (
    <div className={styles.textSectionContainer}>
      <h2> Medese. </h2>
      <p>
        I haven&apos;t been at my best behavior and I haven&apos;t given you the love you deserve by my actions.
        I am not being good to you, and it piled up only to come down yesterday in the form of you telling me you'd leave.
        My stubbornness nearly cost me the one good thing I have in my life, and I am disappointed in myself for failing you.
        There's not enough words I can use to apologize or appease you, so I will let my hands make you a happier woman than you were yesterday.
        ...
        I am sorry, my love.
        I look forward to a brighter future with you as my wife and best friend, and together we'll have the beauty of a life we've dreamed and brought to reality.
